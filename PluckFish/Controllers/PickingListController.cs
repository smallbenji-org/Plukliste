...
namespace PluckFish.Controllers
{
    ...
    {
        private readonly ILogger<PickingListController> _logger;
        private readonly IPickingListRepository pickingListRepository;
        private readonly IProductRepository productRepository;

        public PickingListController(ILogger<PickingListController> logger, IPickingListRepository pickingListRepository, IProductRepository productRepository)
        {
            _logger = logger;
